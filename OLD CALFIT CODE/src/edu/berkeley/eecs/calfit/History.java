...
import edu.berkeley.citris.calfit.CalFit.PersonalPage;
...
//                } 
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			PersonalPage.tabHost.setCurrentTab(0);
			PersonalPage.tabHost.getCurrentView().setId(R.layout.workout);
		    Log.d(TAG, "current view id: " + PersonalPage.tabHost.getCurrentView().getId());
			return true;
		}
		return false;
	}
